...
def save_summary_txt(video_url, summary, transcript, filename="SAS_YouTube1_summary.txt"):
...
if __name__ == "__main__":
    ...
    video_url = sys.argv[1] if len(sys.argv) > 1 else "https://www.youtube.com/watch?v=ODq6V69IX2Y"
    ...
    if transcript and transcript.strip():
        ...
        save_summary_txt(video_url, summary, transcript, filename="SAS_YouTube1__summary.txt")
